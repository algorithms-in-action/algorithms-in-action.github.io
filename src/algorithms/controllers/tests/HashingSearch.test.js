...
describe('HashingSearch', () => {
  ...
  it('Search small table found LP', () => {
    ...
    expect(HashingSearch.run(chunker, { name: "HashingLP", visualiser, target })).toEqual(found);
  });
  ...
  it('Search small table found DH', () => {
    ...
    expect(HashingSearch.run(chunker, { name: "HashingDH", visualiser, target })).toEqual(found);
  });
